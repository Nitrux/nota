...
checkinstall -D -y \
	...
	--provides=nota \
	--requires="libc6,libkf5coreaddons5,libkf5i18n5,libkf5syntaxhighlighting5,libqt5core5a,libqt5gui5,libqt5qml5,libqt5widgets5,libstdc++6,mauikit-git \(\>= 3.0.1+git\),mauikit-filebrowsing-git \(\>= 3.0.1+git\),qml-module-qt-labs-platform" \
	--nodoc \
	--strip=no \
	--stripso=yes \
	--reset-uids=yes \
